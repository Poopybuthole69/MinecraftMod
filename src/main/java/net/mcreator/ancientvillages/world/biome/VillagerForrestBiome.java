...
public class VillagerForrestBiome extends AncientVillagesModElements.ModElement {
	public static Biome biome;
	public VillagerForrestBiome(AncientVillagesModElements instance) {
		super(instance, 17);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				mobSpawnInfo.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(VillagerEntity.entity, 20, 4, 4));
				...
				event.getRegistry().register(biome.setRegistryName("ancient_villages:villager_forrest"));
			}
		}
	}
	@Override
