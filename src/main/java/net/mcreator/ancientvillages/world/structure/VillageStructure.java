...
package net.mcreator.ancientvillages.world.structure;
...
public class VillageStructure extends AncientVillagesModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public VillageStructure(AncientVillagesModElements instance) {
		super(instance, 18);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ancient_villages:village"), configuredFeature);
		}
	}
	@SubscribeEvent
