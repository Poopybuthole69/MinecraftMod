...
import net.mcreator.ancientvillages.procedures.GrapePlantPlantRightClickedProcedure;
...
public class GrapePlantBlock extends AncientVillagesModElements.ModElement {
	@ObjectHolder("ancient_villages:grape_plant")
	public static final Block block = null;
	public GrapePlantBlock(AncientVillagesModElements instance) {
		super(instance, 12);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("grape_plant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ancient_villages:grape_plant"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(GrapeItem.block, (int) (1)));
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				GrapePlantPlantRightClickedProcedure.executeProcedure($_dependencies);
			}
