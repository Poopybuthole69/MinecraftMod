...
public class HardenedLogBlock extends AncientVillagesModElements.ModElement {
	@ObjectHolder("ancient_villages:hardened_log")
	public static final Block block = null;
	public HardenedLogBlock(AncientVillagesModElements instance) {
		super(instance, 25);
	}
