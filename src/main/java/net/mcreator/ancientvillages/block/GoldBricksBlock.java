...
public class GoldBricksBlock extends AncientVillagesModElements.ModElement {
	@ObjectHolder("ancient_villages:gold_bricks")
	public static final Block block = null;
	public GoldBricksBlock(AncientVillagesModElements instance) {
		super(instance, 6);
	}
