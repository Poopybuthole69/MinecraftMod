...
public class GunItem extends AncientVillagesModElements.ModElement {
	@ObjectHolder("ancient_villages:gun")
	public static final Item block = null;
	@ObjectHolder("ancient_villages:entitybulletgun")
	public static final EntityType arrow = null;
	public GunItem(AncientVillagesModElements instance) {
		super(instance, 27);
	}
	...
	public static class ItemRanged extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Gun to shoot"));
		}
