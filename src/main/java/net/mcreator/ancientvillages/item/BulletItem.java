...
public class BulletItem extends AncientVillagesModElements.ModElement {
	@ObjectHolder("ancient_villages:bullet")
	public static final Item block = null;
	public BulletItem(AncientVillagesModElements instance) {
		super(instance, 28);
	}
