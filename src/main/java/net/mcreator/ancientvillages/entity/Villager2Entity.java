...
import net.mcreator.ancientvillages.entity.renderer.Villager2Renderer;
...
public class Villager2Entity extends AncientVillagesModElements.ModElement {
	public static EntityType entity = null;
	public Villager2Entity(AncientVillagesModElements instance) {
		super(instance, 29);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Villager2Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("villager_2")
						.setRegistryName("villager_2");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -6737152, -10092442, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("villager_2_spawn_egg"));
	}
